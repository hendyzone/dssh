...
#[tauri::command]
pub fn desktop_devtools(window: tauri::WebviewWindow) {
...
#[tauri::command]
pub fn desktop_report_error(app: tauri::AppHandle, message: String, stack: String) -> Result<(), String> {
    crate::diagnostics::record(&app, "renderer_error", &message, &stack)
}
